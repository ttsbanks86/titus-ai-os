import csv, os
base = r'C:\Users\tbank\OneDrive\NOLO Video Scheduling\Current Project\Brand2Social Upload Chunks\7PM_2026-06-02'
...
for i,u in enumerate(urls,1):
    ...
    rows=[
      ...
      rowset({'Connected Profile Id':'11596','Connected Profile Name':'edenbanks38','Social Media':'tiktok','Description':desc,'Post Type':'DIRECT_POST','TikTok Privacy':'PUBLIC_TO_EVERYONE','TikTok Comments':'TRUE','TikTok Duet':'TRUE','TikTok Stitch':'TRUE','Tiktok Your Brand':'TRUE','Tiktok Branded Content':'TRUE','Media Url 1':url})]
    out=os.path.join(base, f'B2S_7PM_chunk_{i:02d}.csv')
