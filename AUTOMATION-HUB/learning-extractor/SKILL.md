...
description: Use when Titus sends a URL, screenshot, video/Reel, article, transcript, course, or pasted text and asks to learn from it, extract lessons, turn it into a skill, or implement it in the Titus AI OS. Trigger keywords: learn this, /learn-source, /learn-text, extract lessons, turn this into a skill, can we implement this.
---
