...
- * 1jehuang/jcode (tracked - check for new releases)
- * kpab/claude-fable-5-skills (tracked - check for new releases)
- * ComposioHQ/awesome-claude-skills (tracked - check for new releases)
- * bytedance/deer-flow (tracked - check for new releases)
- * aaif-goose/goose (tracked - check for new releases)
- * n8n-io/n8n (tracked - check for new releases)
- * thewaltero/mythos-router (tracked - check for new releases)
...
1. **Test jcode** â€” Compare semantic memory vs claude-mem
2. **Extract Marco's 100-tool list** â€” When video is available
3. **Monitor Fable 5 updates** â€” Just released June 9, skills still evolving
4. **Investigate mythos-router** â€” Leaked Anthropic reasoning protocol (210 stars)
5. **Build more video templates** â€” Using PROMPT-MINE + HyperFrames studio
