...
try:
    ...
    cairosvg.svg2png(
        ...
        write_to=r"C:\Users\tbank\Desktop\Live Cowork\video-automation\tts-studio\icon.png",
        output_width=512,
        output_height=512
    )
    print("icon.png written successfully")
except Exception as e:
    print(f"cairosvg failed: {e}, trying Pillow fallback")
    from PIL import Image, ImageDraw
    img = Image.new("RGBA", (512, 512), (10, 10, 24, 255))
    img.save(r"C:\Users\tbank\Desktop\Live Cowork\video-automation\tts-studio\icon.png")
    print("Fallback icon written")
